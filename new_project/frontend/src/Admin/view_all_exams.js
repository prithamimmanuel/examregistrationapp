...
export default function ViewAllExams(props) {
    ...
    const handle_submit = (e) => {
        ...
        axios
            .post("http://localhost:5000/displayallexams", {
            })
            .then((res) => {
                // setsubmitClick(true);
                console.log(res);
                if (res.data.error == "none") {
                    ...
                    console.log("res = ",res.data.exams);
                    for (let i = 0; i < res.data.exams.length; i++) {
                        rows1.push(createData(res.data.exams[i].Address, res.data.exams[i].Age, res.data.exams[i].DOB, res.data.exams[i].Exam_Date, res.data.exams[i].Name, res.data.exams[i].Phone_no, res.data.exams[i].Venue, res.data.exams[i].exam_id, res.data.exams[i].paid, res.data.exams[i].seatno, res.data.exams[i].student_id, res.data.exams[i].subject, res.data.exams[i].venue_id));
                    }
